...
export const metadata = {
  ...
  alternates: {
    canonical:
      "https://nakshatranamahacreations.com/corporate-video-production-company-in-bangalore",
  },
  openGraph: {
    title:
      "Corporate Video Production Company in Bangalore | Corporate Videos",
    description:
      "Corporate Video Production Company in Bangalore specializing in creating corporate video, product demos, social media video, personal branding video and more",
    url: "https://nakshatranamahacreations.com/corporate-video-production-company-in-bangalore",
    images: [
      {
        url: "https://nakshatranamahacreations.com/media/BannerImage.png",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    description:
      "Corporate Video Production Company in Bangalore specializing in creating corporate video, product demos, social media video, personal branding video and more",
    images: [
      "https://nakshatranamahacreations.com/media/BannerImage.png",
    ],
    site: "@nncbengaluru",
