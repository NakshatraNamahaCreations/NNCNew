...
export const metadata = {
  ...
  alternates: {
    canonical:
      "https://nakshatranamahacreations.com/mobile-app-development-company-in-bangalore",
  },
  openGraph: {
    title: "Mobile App Development Company in Bangalore | Innovative Apps",
    description:
    ...
    images: [
      {
        url: "https://nakshatranamahacreations.com/media/OBJECTS.png",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    description:
      "Hire the top mobile app development company in Bangalore to build user-friendly, scalable mobile apps. Get a custom app that boosts your business today!",
    images: ["https://nakshatranamahacreations.com/media/OBJECTS.png"],
    site: "@nncbengaluru",
