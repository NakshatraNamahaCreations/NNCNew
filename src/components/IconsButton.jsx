...
export default function IconsButton() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert("Failed to send enquiry. Please check console.");
    }
  };
            ...
            <Card.Body>
              ...
              <Form onSubmit={handleSubmit} className="d-flex flex-column" style={{ color: "black" }}>
                ...
                {formErrors.user_name && (
                  <div style={{ color: "red", fontSize: "13px" }}>{formErrors.user_name}</div>
                )}
                ...
                {formErrors.user_phone && (
                  <div style={{ color: "red", fontSize: "13px" }}>{formErrors.user_phone}</div>
                )}
                ...
                {formErrors.user_email && (
                  <div style={{ color: "red", fontSize: "13px" }}>{formErrors.user_email}</div>
                )}
                ...
                {formErrors.user_service && (
                  <div style={{ color: "red", fontSize: "13px" }}>{formErrors.user_service}</div>
                )}
