      ...
      >
        ...
        <div
          style={{
            position: "absolute",
            top: "-72px",
            left: "75px", // Adjust this value to position the glasses
            width: "300px", // Adjusted to fit the desired size
            height: "100px",
            display: "flex",
            justifyContent: "space-between", // Space between the lenses
            alignItems: "center",
          }}
        >
          {/* Left Eye Lens */}
          <div
            style={{
              ...
              height: "120px",
              borderRadius: "50%", // Circle shape for lens
              backgroundColor: "#fff", // White lens color
              display: "flex",
              justifyContent: "center",
              alignItems: "center",
              marginRight: "-10px", // Negative margin to adjust lens overlap
              zIndex:2
            }}
          >
            <div
              ref={leftEyeRef}
              style={{
                width: "30px", // Eye size inside the lens
                height: "30px",
                borderRadius: "50%",
                backgroundColor: "#002B3A", // Black eye color
              }}
            ></div>
          </div>
          ...
          <div
            style={{
              position: "absolute",
              top: "35px", // Adjust vertical positioning to center it between the lenses
          ...
          <div
            style={{
              ...
              justifyContent: "center",
              alignItems: "center",
              marginLeft: "50px", // Negative margin to adjust lens overlap
              zIndex:2
            }}
          >
            <div
